...
- **Stijl:** terracotta `--color-primary` #C98966 als hoofdkleur, salie-groen `--color-secondary(-dark)` #98C3A4/#82BE93 als vulkleur, `--color-green-text` #31674F (donkergroen) voor **alle groene tekst** — headers, knoppen, badges, /aanraders (de vulgroenen halen te weinig contrast). Zachte UI, ronding, subtiele schaduwen. Pas geen kleuren aan zonder bevestiging. Zie `js/CLAUDE.md §7`.
