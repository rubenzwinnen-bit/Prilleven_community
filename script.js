...
} from './js/supabase.js?v=2.9.0';
import * as Router from './js/router.js?v=2.9.0';
import * as Header from './js/components/header.js?v=2.9.0';
import * as Nav from './js/components/nav.js?v=2.9.0';
import * as Home from './js/components/home.js?v=2.9.0';
import * as RecipeList from './js/components/recipeList.js?v=2.9.0';
import * as RecipeDetail from './js/components/recipeDetail.js?v=2.9.0';
import * as ImportRecipes from './js/components/importRecipes.js?v=2.9.0';
import * as WeekSchedule from './js/components/weekSchedule.js?v=2.9.0';
import * as Favorites from './js/components/favorites.js?v=2.9.0';
import * as ShoppingList from './js/components/shoppingList.js?v=2.9.0';
import * as RecipeForm from './js/components/recipeForm.js?v=2.9.0';
import * as IngredientIcons from './js/components/ingredientIcons.js?v=2.9.0';
import * as EersteHapjes from './js/components/eersteHapjes.js?v=2.9.0';
