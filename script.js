...
import * as Store from './js/store.js?v=4.0.6';
import {
  checkAllowedUser,
  checkCanSignUp,
  authSignUp,
...
} from './js/supabase.js?v=4.0.6';
import * as Router from './js/router.js?v=4.0.6';
import * as Header from './js/components/header.js?v=4.0.6';
import * as Nav from './js/components/nav.js?v=4.0.6';
import * as Home from './js/components/home.js?v=4.0.6';
import * as RecipeList from './js/components/recipeList.js?v=4.0.6';
import * as RecipeDetail from './js/components/recipeDetail.js?v=4.0.6';
import * as ImportRecipes from './js/components/importRecipes.js?v=4.0.6';
import * as WeekSchedule from './js/components/weekSchedule.js?v=4.0.6';
import * as Favorites from './js/components/favorites.js?v=4.0.6';
import * as ShoppingList from './js/components/shoppingList.js?v=4.0.6';
import * as RecipeForm from './js/components/recipeForm.js?v=4.0.6';
import * as IngredientIcons from './js/components/ingredientIcons.js?v=4.0.6';
import * as LearningsLibrary from './js/components/learningsLibrary.js?v=4.0.6';
import * as LearningsDetail from './js/components/learningsDetail.js?v=4.0.6';
import * as Profiel from './js/components/profiel.js?v=4.0.6';
import * as Allergenen from './js/components/allergenen.js?v=4.0.6';
import * as Aanraders from './js/components/aanraders.js?v=4.0.6';
