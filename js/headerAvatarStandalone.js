...
import { sessionGet, sessionClear, invalidateSubscriptionCache } from './supabase.js?v=4.0.12';
import { initialsFromName, colorFromSeed, escapeHtml } from './utils.js?v=4.0.12';
