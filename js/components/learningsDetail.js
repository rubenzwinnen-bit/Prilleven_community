...
import { showToast } from '../utils.js?v=4.0.33';
import { sessionGet, sessionRefreshIfNeeded } from '../supabase.js?v=4.0.33';
import { isLearningCompleted, setLearningCompleted } from '../learningProgress.js?v=4.0.33';
