...
import { showToast } from '../utils.js?v=4.0.32';
import { sessionGet, sessionRefreshIfNeeded } from '../supabase.js?v=4.0.32';
import { isLearningCompleted, setLearningCompleted } from '../learningProgress.js?v=4.0.32';
