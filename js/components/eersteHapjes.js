...
import { escapeHtml, colorFromSeed, initialsFromName, showToast } from '../utils.js?v=2.21.0';
import {
  getMyChildren,
  getMealsForChild,
  getSymptomsForChild,
...
import {
  ...
  getNextStepArticle,
  formatAgeRange,
} from '../eersteHapjesContent.js?v=2.21.0';
import { openChildOnboardingModal } from './childOnboardingModal.js?v=2.21.0';
import { openMealLogModal } from './mealLogModal.js?v=2.21.0';
import { openSymptomLogModal } from './symptomLogModal.js?v=2.21.0';
import { openSymptomDetailModal } from './symptomDetailModal.js?v=2.21.0';
...
} from './allergenIntroModal.js?v=2.21.0';
import { openArticleModal, openArticleListModal } from './articleModal.js?v=2.21.0';
import { openRiskFoodsListModal, openRiskFoodDetailModal } from './riskFoodsModal.js?v=2.21.0';
import { openAgendaModal } from './agendaModal.js?v=2.21.0';
import { renderEhChatBox, bindEhChatBox } from './ehChatBox.js?v=2.21.0';
import {
  getRelevantRiskFoods,
  formatAgeLimit,
} from '../content/eersteHapjes-risk-foods.js?v=2.21.0';
import {
  renderPhaseBanner,
  openPhaseDetailModal,
  openPhaseOverviewModal,
} from './phaseModal.js?v=2.21.0';
import { getSymptomMeta, isRedFlag } from '../content/eersteHapjes-symptoms.js?v=2.21.0';
import { buildSuggestions } from '../eersteHapjesSuggestions.js?v=2.21.0';
import { getRecipes } from '../store.js?v=2.21.0';
import * as Router from '../router.js?v=2.21.0';
...
function bindLogActions(root, child) {
  ...
  if (articleBtn) {
    articleBtn.addEventListener('click', async () => {
      const { getArticleBySlug } = await import('../eersteHapjesContent.js?v=2.21.0');
