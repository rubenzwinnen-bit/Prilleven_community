...
import { showToast, escapeHtml, processImageForUpload, confirm as confirmDialog, nl2br, formatRelativeTime } from '../utils.js?v=2.4.9';
import * as Api from '../communityApi.js?v=2.4.9';
...
import { ensureNickname, getCachedNickname, invalidateNicknameCache }
  from './nicknameModal.js?v=2.4.9';
import { openProfileModal } from './profileModal.js?v=2.4.9';
import { renderPostCard, renderReplyRow, renderPoll } from './timelinePost.js?v=2.4.9';
