...
import { createSymptom, getMealsForChild } from '../eersteHapjesApi.js?v=2.24.0';
import { SYMPTOMS, SEVERITIES, getSymptom } from '../content/eersteHapjes-symptoms.js?v=2.24.0';
