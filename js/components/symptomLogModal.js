...
import { createSymptom, getMealsForChild } from '../eersteHapjesApi.js?v=2.30.0';
import { SYMPTOMS, SEVERITIES, getSymptom } from '../content/eersteHapjes-symptoms.js?v=2.30.0';
import { openSymptomDetailModal } from './symptomDetailModal.js?v=2.30.0';
