...
import { escapeHtml } from '../utils.js?v=2.25.0';
import { createSymptom, getMealsForChild } from '../eersteHapjesApi.js?v=2.25.0';
import { SYMPTOMS, SEVERITIES, getSymptom } from '../content/eersteHapjes-symptoms.js?v=2.25.0';
import { openSymptomDetailModal } from './symptomDetailModal.js?v=2.25.0';
