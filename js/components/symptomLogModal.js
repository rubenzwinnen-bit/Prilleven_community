...
import { createSymptom, getMealsForChild } from '../eersteHapjesApi.js?v=2.21.0';
import { SYMPTOMS, SEVERITIES, getSymptom } from '../content/eersteHapjes-symptoms.js?v=2.21.0';
