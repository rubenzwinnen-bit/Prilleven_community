...
import { escapeHtml, showToast } from '../utils.js?v=2.24.0';
import { PHASES, getPhase } from '../content/eersteHapjes-phases.js?v=2.24.0';
import { togglePhaseCheck, advancePhase, getPhases } from '../eersteHapjesApi.js?v=2.24.0';
