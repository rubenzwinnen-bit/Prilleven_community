...
} from '../utils.js?v=2.12.0';
import { scanRecipeForRisks } from '../content/eersteHapjes-risk-foods.js?v=2.12.0';
...
import { isRecipeSafeForChild, getRecipeAlternatives } from '../eersteHapjesEligibility.js?v=2.12.0';
