...
import { showToast, confirm } from '../utils.js?v=4.0.8';
import { sessionGet, sessionRefreshIfNeeded, supabaseStorageUploadXhr, learningsThumbPublicUrl } from '../supabase.js?v=4.0.8';
