...
import { showToast, confirm } from '../utils.js?v=2.3.9';
import { sessionGet, sessionRefreshIfNeeded, supabaseStorageUploadXhr, learningsThumbPublicUrl } from '../supabase.js?v=2.3.9';
