...
import { showToast, confirm } from '../utils.js?v=3.5.2';
import { sessionGet, sessionRefreshIfNeeded, supabaseStorageUploadXhr, learningsThumbPublicUrl } from '../supabase.js?v=3.5.2';
