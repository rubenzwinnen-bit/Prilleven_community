...
import * as Router from '../router.js?v=4.0.30';
import { showToast, confirm } from '../utils.js?v=4.0.30';
import { sessionGet, sessionRefreshIfNeeded, supabaseStorageUploadXhr, learningsThumbPublicUrl } from '../supabase.js?v=4.0.30';
import { getLearningStatus } from '../learningProgress.js?v=4.0.30';
