...
import * as Router from '../router.js?v=2.5.4';
import { showToast, confirm } from '../utils.js?v=2.5.4';
import { sessionGet, sessionRefreshIfNeeded, supabaseStorageUploadXhr, learningsThumbPublicUrl } from '../supabase.js?v=2.5.4';
