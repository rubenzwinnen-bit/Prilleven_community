...
import { showToast, confirm } from '../utils.js?v=2.4.2';
import { sessionGet, sessionRefreshIfNeeded, supabaseStorageUploadXhr, learningsThumbPublicUrl } from '../supabase.js?v=2.4.2';
