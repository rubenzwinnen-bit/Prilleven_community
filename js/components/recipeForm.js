...
import * as Router from '../router.js?v=2.6.0';
import { supabaseStorageUpload, dataUriToBlob } from '../supabase.js?v=2.6.0';
import { showToast, ALLERGENS, MEAL_MOMENTS, escapeHtml } from '../utils.js?v=2.6.0';
