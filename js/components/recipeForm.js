...
import { supabaseStorageUpload, dataUriToBlob } from '../supabase.js?v=3.5.2';
import { showToast, ALLERGENS, MEAL_MOMENTS, AGE_PRESETS, escapeHtml, getAllergenLabel, normalizeAllergen } from '../utils.js?v=3.5.2';
