...
import { supabaseStorageUpload, dataUriToBlob } from '../supabase.js?v=4.0.20';
import { showToast, ALLERGENS, MEAL_MOMENTS, AGE_PRESETS, escapeHtml, getAllergenLabel, normalizeAllergen } from '../utils.js?v=4.0.20';
