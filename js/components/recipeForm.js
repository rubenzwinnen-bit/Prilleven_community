...
import * as Router from '../router.js?v=4.0.19';
import { supabaseStorageUpload, dataUriToBlob } from '../supabase.js?v=4.0.19';
import { showToast, ALLERGENS, MEAL_MOMENTS, AGE_PRESETS, escapeHtml, getAllergenLabel, normalizeAllergen } from '../utils.js?v=4.0.19';
