...
import { escapeHtml, processImageForUpload, showToast, initialsFromName, colorFromSeed } from '../utils.js?v=2.30.0';
import { sessionGet } from '../supabase.js?v=2.30.0';
import * as Api from '../communityApi.js?v=2.30.0';
import { getMyChildren, deleteChild } from '../eersteHapjesApi.js?v=2.30.0';
import { openChildOnboardingModal } from './childOnboardingModal.js?v=2.30.0';
import { openEersteHapjesHub } from './eersteHapjesHub.js?v=2.30.0';
