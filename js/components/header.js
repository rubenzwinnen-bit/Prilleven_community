...
import { sessionClear, sessionGet, invalidateSubscriptionCache } from '../supabase.js?v=2.4.12';
import { initialsFromName, colorFromSeed, escapeHtml } from '../utils.js?v=2.4.12';
