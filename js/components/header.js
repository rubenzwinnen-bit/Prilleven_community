...
import { sessionClear, sessionGet, invalidateSubscriptionCache } from '../supabase.js?v=2.30.0';
import { initialsFromName, colorFromSeed, escapeHtml } from '../utils.js?v=2.30.0';
