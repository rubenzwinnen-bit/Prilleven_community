...
import { sessionClear, sessionGet, invalidateSubscriptionCache } from '../supabase.js?v=2.29.0';
import { initialsFromName, colorFromSeed, escapeHtml } from '../utils.js?v=2.29.0';
