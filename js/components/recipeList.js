...
import * as RecipeCard from './recipeCard.js?v=2.16.0';
import { showToast, confirm, MEAL_MOMENTS, ALLERGENS, escapeHtml } from '../utils.js?v=2.16.0';
import { ageMonthsFromBirthdate } from '../eersteHapjesContent.js?v=2.16.0';
import { loadActiveChild } from './eersteHapjes.js?v=2.16.0';
import { getAllergensForChild } from '../eersteHapjesApi.js?v=2.16.0';
import { isRecipeSafeForChild } from '../eersteHapjesEligibility.js?v=2.16.0';
