...
import * as RecipeCard from './recipeCard.js?v=2.14.0';
import { showToast, confirm, MEAL_MOMENTS, ALLERGENS, escapeHtml } from '../utils.js?v=2.14.0';
...
import { isRecipeSafeForChild } from '../eersteHapjesEligibility.js?v=2.14.0';
