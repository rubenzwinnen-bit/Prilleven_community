...
import * as RecipeCard from './recipeCard.js?v=3.0.0';
import { showToast, confirm, MEAL_MOMENTS, ALLERGENS, getAllergenLabel, normalizeAllergen } from '../utils.js?v=3.0.0';
