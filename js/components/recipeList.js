...
import * as RecipeCard from './recipeCard.js?v=4.0.30';
import { showToast, confirm, MEAL_MOMENTS, ALLERGENS, getAllergenLabel, normalizeAllergen, AGE_FILTER_OPTIONS, getRecipeMinAge } from '../utils.js?v=4.0.30';
