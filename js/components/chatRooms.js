...
import * as Api from '../chatRoomsApi.js?v=2.5.6';
import { formatRelativeTime } from '../utils.js?v=2.5.6';
import { renderAvatar, renderAuthorMeta } from '../profileRender.js?v=2.5.6';
