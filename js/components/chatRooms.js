...
import * as Api from '../chatRoomsApi.js?v=4.0.30';
import { blockUser } from '../communityApi.js?v=4.0.30';
import { formatRelativeTime } from '../utils.js?v=4.0.30';
import { renderAvatar, renderAuthorMeta } from '../profileRender.js?v=4.0.30';
