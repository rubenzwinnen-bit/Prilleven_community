...
import * as Api from '../chatRoomsApi.js?v=2.5.5';
import { formatRelativeTime } from '../utils.js?v=2.5.5';
import { renderAvatar, renderAuthorMeta } from '../profileRender.js?v=2.5.5';
