...
import { sessionRefreshIfNeeded } from './supabase.js?v=3.5.2';
import { escapeHtml, processImageForUpload, showToast, confirm as confirmDialog } from './utils.js?v=3.5.2';
