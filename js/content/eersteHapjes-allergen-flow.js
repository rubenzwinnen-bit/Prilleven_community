/* ============================================
   ...
   - Leeftijd-conditie:
       * default: vóór 12 maanden introduceren (`introBefore: 12`)
       * koemelk + honing: pas vanaf 12 maanden (`introFrom: 12`)
   - Bij reactie:
...
export const ALLERGEN_FLOW = [
  {
    ...
    repeatTarget: 3,
    suggestedFood: 'Hardgekookt eigeel pletten en mengen met (moeder)melk, of droog bakken en in repen aanbieden.',
    note: 'Begin met eigeel apart, eiwit komt later.',
  },
  {
    key: 'ei-wit',
    label: 'Eiwit (heel ei)',
    ...
    ageCondition: { introBefore: 12 },
    repeatTarget: 3,
    suggestedFood: 'Heel ei (wit + geel) klutsen en bakken in vetstof, in repen aanbieden.',
    note: 'Pas introduceren nadat eigeel succesvol verlopen is.',
  },
  {
    key: 'pinda',
    label: 'Pinda',
  ...
  {
    key: 'gluten-niet-tarwe',
    label: 'Gluten (niet-tarwe)',
    icon: '🌾',
    order: 9,
    ageCondition: { introBefore: 12 },
    repeatTarget: 3,
    suggestedFood: 'Spelt-, rogge- of haverpap. Kook in (moeder)melk en plet/mix tot gewenste consistentie.',
    note: 'Eerste gluten-bron — tarwe komt apart.',
  },
  {
    key: 'tarwe',
    label: 'Tarwe',
  ...
  },
  {
    ...
    ageCondition: { introFrom: 12 },
    repeatTarget: 3,
    suggestedFood: 'Een halve koffielepel honing op een lepeltje of door yoghurt.',
    note: 'Pas vanaf 12 maanden — eerder = botulisme-risico.',
  },
  {
    key: 'citrus',
    label: 'Citrus',
    ...
    ageCondition: { introBefore: 12 },
    repeatTarget: 3,
    suggestedFood: 'Stukje sinaasappel of mandarijn zonder schil/pitten, in kleine partjes.',
    note: 'Kan rood worden rond de mond — irritatie, geen allergie.',
  },
];
